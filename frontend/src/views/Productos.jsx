...
export default function Productos() {
    ...
    const productosCategory = categoryInfo.find(
        (category) => category.name.toUpperCase() === "PRODUCTOS"
    );
    ...
    const filteredProducts = selectedSubcategory
        ...
        : productInfo.filter((info) => info.category.name === "productos");
    ...
    return (
        <div className="flex flex-row w-full py-20 px-5 gap-10 font-roboto-condensed min-h-[526px]">
            ...
            <div className="w-[20%]">
                ...
                {productosCategory?.subcategories.map((subcategory, index) => (
                    <button
                        key={index}
